                            ...
                            <ul>
                                ...
                                <li><a>Kategories<span class="arrow_carrot-down"></span></a>
                                    <ul class="dropdown">
                                        ...
                                        <li><a href="./twitch.php">Podcast</a></li>
                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="hero__text">
                                ...
                                <h2>Network_Rocket</h2>
                                <p>Live auf Twitch für euch...</p>
                                <a href="https://twitch.tv/network_rocket" target="_blank"><span>Watch Now</span> <i class="fa fa-angle-right"></i></a>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="trending__product">
                        <div class="row">
                            ...
                            <div class="col-lg-4 col-md-4 col-sm-4">
                                <div class="btn__all">
                                    <a href="./twitch.php" class="primary-btn">View All <span class="arrow_right"></span></a>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-lg-4 col-md-6 col-sm-6">
                                <div class="product__item">
                                    <div class="product__item__pic set-bg" data-setbg="videos/tarnmodus.jpg">
                                    ...
                                    <div class="product__item__text">
                                        ...
                                        <h5><a href="whitewolf_113-details.php">Tarnmodus LvL 9000!</a></h5>
                                    </div>
                                </div>
                            </div>
                           <div class="col-lg-4 col-md-6 col-sm-6">
                                <div class="product__item">
                                    <div class="product__item__pic set-bg" data-setbg="videos/steinefresser.jpg">
                            ...
                            <div class="col-lg-4 col-md-6 col-sm-6">
                                <div class="product__item">
                                    <div class="product__item__pic set-bg" data-setbg="img/live/live-1.jpg">
                                        <div class="ep">LIVE</div>
                                    </div>
                                    <div class="product__item__text">
                                        <ul>
                                          
                                        </ul>
                                        <h5><a href="https://www.twitch.tv/dr_wolf20" target="_blank">Steine_fresser18</a></h5>
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-4 col-md-6 col-sm-6">
                                <div class="product__item">
                                    ...
                                    <div class="product__item__text">
                                        ...
                                        <h5><a href="https://www.twitch.tv/dr_estugon" target="_blank">dr_estugon</a></h5>
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-4 col-md-6 col-sm-6">
                                <div class="product__item">
                                    ...
                                    <div class="product__item__text">
                                        ...
                                        <h5><a href="https://www.twitch.tv/simulationmaiki0815" target="_blank">simulationmaiki0815</a></h5>
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-4 col-md-6 col-sm-6">
                                <div class="product__item">
                                    ...
                                    <div class="product__item__text">
                                        ...
                                        <h5><a href="https://www.twitch.tv/e_s_gaming_" target="_blank">e_s_gaming_</a></h5>
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-4 col-md-6 col-sm-6">
                                <div class="product__item">
                                    ...
                                    <div class="product__item__text">
                                        ...
                                        <h5><a href="https://www.twitch.tv/firehead36" target="_blank">firehead36</a></h5>
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-4 col-md-6 col-sm-6">
                                <div class="product__item">
                                    ...
                                    <div class="product__item__text">
                                        ...
                                        <h5><a href="https://www.twitch.tv/snaayk" target="_blank">snaayk</a></h5>
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-4 col-md-6 col-sm-6">
                                <div class="product__item">
                                    <div class="product__item__pic set-bg" data-setbg="img/live/live-7.jpg">
                                    ...
                                    <div class="product__item__text">
                                        ...
                                        <h5><a href="https://www.twitch.tv/zmichi0" target="_blank">zmichi0</a></h5>
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-4 col-md-6 col-sm-6">
                                <div class="product__item">
                                    <div class="product__item__pic set-bg" data-setbg="img/live/live-8.jpg">
                                    ...
                                    <div class="product__item__text">
                                        ...
                                        <h5><a href="https://www.twitch.tv/whitewolf_113" target="_blank">whitewolf_113</a></h5>
                                    </div>
                                </div>
                            </div>
                        </div>
        ...
        <div class="row">
            <div class="col-lg-3">
                <div class="footer__logo">
                    <a href="./welcome.php"><img src="img/logo.png" alt=""></a>
                </div>
            </div>
            <div class="col-lg-6">
