    ...
    <section class="anime-details spad">
        <div class="container">
            <div class="anime__details__content">
                <div class="row">
                    <div class="col-lg-3">
                        <div class="anime__details__pic set-bg" data-setbg="/pages/videos/steinefresser.jpg">
                        ...
                        <div class="anime__details__text">
                            ...
                            <div class="anime__details__widget">
                                <div class="row">
                                    ...
                                    <div class="col-lg-6 col-md-6">
                                        <ul>
                                            <li><span>Streamer:</span>Steine_fresser18</li>
                                            <li><span>Twitch:</span><a href="https://www.twitch.tv/dr_wolf20" target="_blank">Zum Kanal</a></li>
                                            <li><span>Instagram:</span><a href="https://www.instagram.com/roy_18karat/" target="_blank">Zum Kanal</a></li>
                            ...
                            <div class="anime__details__btn">
                               <!-- <a href="#" class="follow-btn"><i class="fa fa-heart-o"></i> Follow</a>-->
                                <a href="steine_fresser-watching.php" class="watch-btn"><span>Watch Now</span> <i
