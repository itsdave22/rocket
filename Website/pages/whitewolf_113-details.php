    ...
    <section class="anime-details spad">
        <div class="container">
            <div class="anime__details__content">
                <div class="row">
                    <div class="col-lg-3">
                        <div class="anime__details__pic set-bg" data-setbg="videos/tarnmodus.jpg">
                        ...
                        <div class="anime__details__text">
                            ...
                            <div class="anime__details__widget">
                                <div class="row">
                                    <div class="col-lg-6 col-md-6">
                                        <ul>
                                            <li><span>Type:</span> Clips</li>
                                            <li><span>Studios:</span> Rocket</li>
                                            <li><span>Date aired:</span> September 10, 2022</li>
                                            <li><span>Genre:</span> Action, Adventure, Fantasy,</li>
                                        </ul>
                                    </div>
                                    <div class="col-lg-6 col-md-6">
                                        <ul>
                                            <li><span>Streamer:</span>Whitewolf_113</li>
                                            <li><span>Twitch:</span><a href="https://twitch.tv/whitewolf_113" target="_blank">Zum Kanal</a></li>
                                            <li><span>Instagram:</span><a href="https://www.instagram.com/whitewolf_113/" target="_blank">Zum Kanal</a></li>
                            ...
                            <div class="anime__details__btn">
                               <!-- <a href="#" class="follow-btn"><i class="fa fa-heart-o"></i> Follow</a>-->
                                <a href="whitewolf_113-watching.php" class="watch-btn"><span>Watch Now</span> <i
